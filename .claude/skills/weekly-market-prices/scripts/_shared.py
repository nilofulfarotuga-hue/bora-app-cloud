...
(Cópia do _shared de sync-market-photos; mantém cada skill auto-contida.)
"""
...
# Preço por scraping confirmado SÓ p/ Continente. Outros bloqueados/fora de scope.
PRICE_SUPPORTED = {"continente-guarda"}
PRICE_BLOCKED_ROBOTS = {"auchan-guarda", "pingodoce-guarda"}
DEFAULT_RATE = 3.5
