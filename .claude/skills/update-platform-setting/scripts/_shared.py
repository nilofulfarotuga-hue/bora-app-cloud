...
# Substrings que tornam uma chave "blindada" (fórmulas sagradas).
BLINDADAS = ["stripe_", "dispatch_", "pricing_", "commission_", "fee_"]


def is_blindada(key: str) -> bool:
    return any(b in key for b in BLINDADAS)
