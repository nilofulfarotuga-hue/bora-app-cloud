...
Prova final, 21h03 UTC: o Chrome do PC abriu `boraguarda.com/verificar/?t=3vZdoB22ZHMz` com o código verdadeiro e a página disse "Dados confirmados pela Bora", com a matrícula CH-90-PX; o código inventado deu "Código de verificação inválido". Confirmado também pelo servidor: o contador de consultas desse código passou de zero para um às 21h02. Resta só juntar o pedido 1 do bora-site ao `main`.
