...
Antes de tudo: o PUSH não saiu. O trabalho está todo commitado localmente (commit a0b781a4 na branch tvde/reserva-agendada-2026-08-20), mas este computador novo não tem nenhuma credencial do GitHub — nem token guardado, nem gestor de credenciais com sessão, nem gh autenticado — e o gestor de credenciais recusa abrir a janela de entrada a partir de uma sessão automática. Procurei token em todos os sítios habituais (ficheiros de ambiente, Hermes, QG, cofre do Windows) e não existe nenhum nesta máquina; as credenciais ficaram no PC antigo. Para destravar de vez chega UMA vez: abrir um terminal normal nesta máquina, correr um git push neste repositório e completar a janela do GitHub que abre no browser — a partir daí todos os pushes automáticos passam a funcionar. Assim que houver credencial, é só correr git push origin tvde/reserva-agendada-2026-08-20 e confirmar na API.
