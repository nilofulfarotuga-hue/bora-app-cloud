...
- **Cardápio digital + Reservas de mesa** (secção 14)
- **Takeaway** em parceiros
- **Gorjetas** (secção 4.5)
- **Avaliações** com etiquetas (secção 13)
- **Driver Help** (secção 5.2)
- **Cancelamento pelo cliente** (secção 8.3)
- **Painel admin completo** (secção 16)
- **GDPR** (secção 20)
- **Foto obrigatória em sendPackage e carryGroceries**
- **Câmara do mapa rodar com bearing**
