-- B1 (2026-06-12) — Cap de distância de entrega no create_order.
-- Auditoria pré-launch: pedido real 7efdca55 com distance_km=9125 →
-- delivery_fee €4.563 (GPS corrompido). Não havia limite superior.
-- Lê platform_settings.delivery_max_distance_km (15) com fallback 15.
-- Takeaway não tem entrega → isento.
-- Única alteração vs versão anterior: DECLARE v_max_distance_km + bloco
-- de validação após o check INVALID_DISTANCE.
