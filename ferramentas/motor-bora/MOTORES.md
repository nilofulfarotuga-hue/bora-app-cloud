# MOTORES — o roteador Motor Bora (pc), gerado 2026-09-04T06:39
...
|---|---|---|---|---|---|---|---|
| groq | sim | 12/12/0 | 22230 | — | não |  | o mais rapido; 8 000 tokens/min por modelo no plano gratis |
| cerebras | **sem chave** | 0/0/0 | 0 | — | não |  | ~1 M tokens/dia, muito rapido |
| gemini | sim | 10/9/1 | 2948 | — | modelos: gemini-3-flash-preview |  | quota gratis por PROJETO e por modelo; esgota cedo |
...
| kilo | sim | 7/6/1 | 8397 | — | não |  | Kilo Gateway: sem chave, sem conta; so modelos ':free'; ~200 pedidos/h |
...
**Custo simulado de hoje: 0.0169 €** (não se paga nada — é o que isto custaria ao preço de tabela dos modelos pagos equivalentes; por fornecedor na coluna abaixo).
