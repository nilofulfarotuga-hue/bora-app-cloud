...
(Cópia do _shared das outras skills S4-A; mantém cada skill auto-contida.)
"""
...
def require_market(rid: str) -> None:
    if rid not in MARKET_STORES:
        log(f"'{rid}' não é loja de mercado (allowlist). Recusado.", "ERROR")
        sys.exit(2)
