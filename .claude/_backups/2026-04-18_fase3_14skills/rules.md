...
## SKILLS DISPONÍVEIS NO SISTEMA (FASE 2.B.2 COMPLETA — 36 SKILLS)
...
> Lista actualizada após Lote 6 da Fase 2.B.2. Para detalhe de cada skill, abrir o respectivo `.md` em `.claude/.ai/skills/`.
