"""Helpers S4-C (DevOps). Reutiliza o motor S1 + audit_log + constantes."""
...
PROJECT_REF = "ojykpzwqrtusfeakzrna"

# Edge Functions financeiras/críticas — deploy exige flag explícita.
PROTECTED_FNS = {"dispatch-engine", "create-payment-intent", "refund",
                 "stripe-webhook", "create-mbway-payment-intent"}
